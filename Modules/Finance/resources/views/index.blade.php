<x-app-layout>
    ...
    <script>
        (function() {
            function registerFinanceDashboard() {
                Alpine.data('financeDashboard', () => ({
                    apiBase: '/api/v1/finance',
                    ...
                    async loadPaymentHistory() {
                        this.loading = true;
                        try {
                            const response = await this.request('/payment-history?per_page=15');
                            console.log('Finance payment history response:', response);
                            ...
                            console.log('Finance payment history items:', this.paymentHistory);
            ...
            if (typeof Alpine !== 'undefined') {
                registerFinanceDashboard();
            } else {
                document.addEventListener('alpine:init', registerFinanceDashboard);
            }
        })();
    </script>

    <div class="py-8" x-data="financeDashboard" x-init="init()">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/30">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="balance?.total_payments_count ?? (paymentHistory?.length || 0)"></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white shadow-lg shadow-emerald-500/30">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="balance?.total_income ? formatCurrency(balance.total_income / 100) : '$0.00'"></p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-red-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg shadow-red-500/30">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="balance?.total_expenses ? formatCurrency(balance.total_expenses / 100) : '$0.00'"></p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg shadow-cyan-500/30">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="balance?.net_balance ? formatCurrency(balance.net_balance / 100) : '$0.00'"></p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg shadow-green-500/30">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold" x-text="balance?.campaign_contributions ? formatCurrency(balance.campaign_contributions / 100) : '$0.00'"></p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
